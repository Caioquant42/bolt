...
def get_screener_analysis():
    ...
    json_file_path = os.path.join(current_dir, "export", "ibov_overbought_oversold_rsi_results.json")
...
def run_screener_analysis():
    ...
    json_file_path = os.path.join(current_directory, 'export', 'ibov_overbought_oversold_rsi_results.json')
