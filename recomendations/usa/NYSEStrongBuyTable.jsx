...
import { fetchNYSEStrongBuyAnalysis } from "/src/__api__/db/apiService";
...
export default function NYSEStrongBuyTable() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Error fetching NYSE Strong Buy analysis:", error);
      }
    };
    fetchData();
  }, []);
  ...
  return (
    <StyledTableContainer>
      <StyledTable size="small" aria-label="nyse strong buy analysis table">
        <TableHead>
          <TableRow>
